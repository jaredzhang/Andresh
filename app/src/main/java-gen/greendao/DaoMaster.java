...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static abstract class OpenHelper extends SQLiteAssetHelper {
        ...
        protected OpenHelper(Context context, String name, String storageDirectory,
                CursorFactory factory, int version) {
            super(context, name, context.getExternalFilesDir(null).getAbsolutePath(), factory, version);
        }
//        @Override
