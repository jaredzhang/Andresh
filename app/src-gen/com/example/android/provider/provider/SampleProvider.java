package com.example.android.provider.provider;

import com.example.android.provider.database.SampleDatabase;
...
public class SampleProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.android.provider.provider";

    public static final Uri AUTHORITY_URI = Uri.parse("content://" + AUTHORITY);

    public static final Uri AGENDA_CONTENT_URI = Uri.withAppendedPath(SampleProvider.AUTHORITY_URI, AgendaContent.CONTENT_PATH);

    public static final Uri CALENDAR_ITEM_CONTENT_URI = Uri.withAppendedPath(SampleProvider.AUTHORITY_URI, CalendarItemContent.CONTENT_PATH);

    public static final Uri AGENDA_ITEM_GROUP_CONTENT_URI = Uri.withAppendedPath(SampleProvider.AUTHORITY_URI, AgendaItemGroupContent.CONTENT_PATH);

    public static final Uri AGENDA_ITEM_CONTENT_URI = Uri.withAppendedPath(SampleProvider.AUTHORITY_URI, AgendaItemContent.CONTENT_PATH);

    public static final Uri AGENDA_JOIN_CALENDAR_ITEM_CONTENT_URI = Uri.withAppendedPath(SampleProvider.AUTHORITY_URI, AgendaJoinCalendarItemContent.CONTENT_PATH);
    public static final Uri AGENDA_ITEM_GROUP_JOIN_AGENDA_ITEM_CONTENT_URI = Uri.withAppendedPath(SampleProvider.AUTHORITY_URI, AgendaItemGroupJoinAgendaItemContent.CONTENT_PATH);
    ...
    public static final class AgendaContent implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.sample_database.agenda";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.sample_database.agenda";
    }

    public static final class CalendarItemContent implements BaseColumns {
        public static final String CONTENT_PATH = "calendaritem";
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.sample_database.calendaritem";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.sample_database.calendaritem";
    }
    ...
    public static final class AgendaItemGroupContent implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.sample_database.agendaitemgroup";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.sample_database.agendaitemgroup";
    }

    public static final class AgendaItemContent implements BaseColumns {
        public static final String CONTENT_PATH = "agendaitem";
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.sample_database.agendaitem";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.sample_database.agendaitem";
    }
    ...
    public static final class AgendaJoinCalendarItemContent implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.sample_database.agenda_join_calendar_item";
    }
    public static final class AgendaItemGroupJoinAgendaItemContent implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.sample_database.agenda_item_group_join_agenda_item";
    }
